...
const CustomerFavouritedFood = ({ route, navigation}) => {
    ...
    const fetchData = async () => {
      try {
        ...
        const filteredFood = foodData.filter((food) => {
          const matchingUser = userData.find((user) => user.favouriteItems.includes(food.foodName));
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>My Favorited Foods</Text>
      <TextInput
...
export default CustomerFavouritedFood;
